...
import org.youth.sadhana.core.models.Score;
...
import static org.youth.androidbase.utils.InterfaceUtils.dpToPixels;
import static org.youth.androidbase.utils.InterfaceUtils.getDimension;
...
public class ScoreChart extends ScrollableChart
{
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        for (int k = 0; k < nColumns; k++)
        {
            ...
            double score = (double)scores.get(offset).getValue();
