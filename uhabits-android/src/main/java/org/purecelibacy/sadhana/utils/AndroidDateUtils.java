...
public class AndroidDateUtils
{
    ...
    {
        String shortDayNames[] = org.purecelibacy.sadhana.core.utils.DateUtils.getShortDayNames();
        String longDayNames[] = org.purecelibacy.sadhana.core.utils.DateUtils.getLongDayNames();
