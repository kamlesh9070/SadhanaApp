...
package org.purecelibacy.sadhana.activities.habits.edit.views;
...
public class NameDescriptionPanel extends FrameLayout
{
    ...
    public void disableNameView() {
        tvName.setEnabled(false);
        tvDescription.setEnabled(false);
    }

    public void setTvNameError(String string) {
        tvName.setError(string);
        Resources res = getResources();
        //tvName.setError(res.getString(string));
    }
    @NonNull
