...
import static org.purecelibacy.androidbase.utils.InterfaceUtils.*;
...
public class HistoryChart extends ScrollableChart
{
    ...
    private void initColors()
    {
        ...
        else
        {
            ...
            reverseTextColor = res.getColor(R.attr.lowContrastReverseTextColor);
