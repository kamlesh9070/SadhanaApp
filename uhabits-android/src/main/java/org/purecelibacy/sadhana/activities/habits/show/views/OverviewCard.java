...
public class OverviewCard extends HabitCard
{
    ...
    @BindView(R.id.totalMonthCountLabel)
    TextView totalMonthCountLabel;
    ...
    private void refreshScore()
    {
        ...
        totalMonthCountLabel.setText(String.valueOf(cache.totalMonthCount));
        ...
        totalMonthCountLabel.setTextColor(yearDiff >= 0 ? color : inactiveColor);
        postInvalidate();
    }
    ...
    private class RefreshTask implements Task
    {
        ...
        public void doInBackground()
        {
            ...
            Timestamp firstDay = DateUtils.getFirstDateOfCurrentMonth();
            cache.totalMonthCount = habit.getRepetitions().getCountByInterval(firstDay,today);
