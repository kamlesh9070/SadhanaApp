...
import org.purecelibacy.sadhana.activities.habits.list.*;
                                                      ...
                                                      ListHabitsSelectionMenuBehavior.Adapter
{
                                 ...
                                 int position)
    {
        ...
        String remarks[] = cache.getCheckmarkRemarks(habit.getId());
        boolean selected = this.selected.contains(habit);

        listView.bindCardView(holder, habit, score, checkmarks, remarks, selected);
    }
