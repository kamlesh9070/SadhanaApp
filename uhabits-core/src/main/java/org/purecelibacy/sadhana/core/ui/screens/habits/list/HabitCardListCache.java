...
public class HabitCardListCache implements CommandRunner.Listener
{
    ...
    public String[] getCheckmarkRemarks(long habitId)
    {
        return data.remarks.get(habitId);
    }
    ...
    private class CacheData
    {
        ...
        public HashMap<Long, String[]> remarks;
        ...
        public void copyRemarksFrom(@NonNull CacheData oldData)
        {
            String[] empty = new String[checkmarkCount];

            for (Long id : id_to_habit.keySet())
            {
                if (oldData.remarks.containsKey(id))
                    remarks.put(id, oldData.remarks.get(id));
                else remarks.put(id, empty);
            }
        }
    ...
    private class RefreshTask implements Task
    {
        ...
        public void doInBackground()
        {
            ...
            for (int position = 0; position < newData.habits.size(); position++)
            {
                ...
                newData.remarks.put(id,habit.getCheckmarks().getRemkars(dateFrom,dateTo));
        ...
        private void performInsert(Habit habit, int position)
        {
            ...
            data.remarks.put(id, newData.remarks.get(id));
