...
package org.purecelibacy.sadhana.core.models.sqlite;
...
import org.purecelibacy.sadhana.core.models.memory.*;
import org.purecelibacy.sadhana.core.models.sqlite.records.*;
...
public class SQLiteRepetitionList extends RepetitionList
{
    ...
    @Override
    public int getCountByInterval(Timestamp timeFrom, Timestamp timeTo)
    {
        loadRecords();
        return list.getCountByInterval(timeFrom, timeTo);
    }
