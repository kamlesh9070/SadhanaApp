...
import static org.purecelibacy.sadhana.core.ui.screens.habits.list.ListHabitsBehavior.Message.COULD_NOT_EXPORT;
import static org.purecelibacy.sadhana.core.ui.screens.habits.list.ListHabitsBehavior.Message.COULD_NOT_GENERATE_BUG_REPORT;
import static org.purecelibacy.sadhana.core.ui.screens.habits.list.ListHabitsBehavior.Message.DATABASE_REPAIRED;
...
public class ListHabitsBehaviorTest extends BaseUnitTest
{
    ...
    public void testOnEdit()
    {
        ...
        verify(screen).showNumberPicker(eq(0.1), eq("miles"),"Test",habit2, picker.capture());
        picker.getValue().onNumberPicked(100,"Test");
